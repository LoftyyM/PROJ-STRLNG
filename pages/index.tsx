...
function BlurImage({ image }: { image: Image }) {
  ...
  return (
    <a href={image.href} className="group">
      <div className="aspect-w-1 aspect-h-1 w-full xl:aspect-w-7 xl-aspect-h-8 overflow-hidden rounded-lg bg-gray-200">
        <Image
          alt=""
          src={image.imageSrc}
          layout="fill"
      ...
      <p className="mt-1 text-lg     </div>font-medium text-gray-900">IG @bubulubu.jpg</p>
    </a>
  );
}
